...
\vspace{6pt}\textbf{Keywords:} \nnn{electrocardiogram, ECG, expert system, ECG recognition, electrocardiosignal}.
\end{abstract}
...
A comparative dynamics analysis of EGC of \nnn{abnormal} hearth rhythms with various arrhythmia and conduction disorder has been carried on during patient observations of \nnn{the primary manifestations нof undesirable side effects on the months-long anti-tuberculosis chemotherapy in patients with comorbid cardiovascular disease}.  The \nnn{abnormalities} are as follows (with the number of observations): the rhythm of the right atrium (18 cases), atrioventricular block I (7 cases), full blockade of the left His'  leg bundle (2 cases), Brugad syndrome (7 cases), sick sinus syndrome (1 case), pacemarker's migration on the atrias (2 cases), atrial fibrillation (10 cases), lengthening the interval Q -T syndrome (1 case), shortening of PQ interval – syndrome premature ventricular heart Сlerk-Levi-Cristesco (CLC) (12 cases), fatal syndrome  of premature ventricular Wolff-Parkinson-White (WPW), type "B" (1 case), acute myocardial infarction with the formation of pathological Q-wave (3 cases), acute myocardial infarction without Q-peak (-) and with ST-segment rise (3 cases), sinus tachycardia (4 cases), isolated syndrome early ventricular repolarization (4 cases).
